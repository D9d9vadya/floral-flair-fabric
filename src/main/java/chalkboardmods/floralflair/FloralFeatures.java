...
public class FloralFeatures {
    ...
    public static final ConfiguredFeature<?,?> ROSE_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.ROSE.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().roseDensity).build());
    public static final ConfiguredFeature<?,?> SUNSET_POPPY_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.SUNSET_POPPY.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().sunsetPoppyDensity).build());
    public static final ConfiguredFeature<?,?> JUNGLE_GEM_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.JUNGLE_GEM.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().jungleGemDensity).build());
    public static final ConfiguredFeature<?,?> PULSE_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.PULSE_PETAL.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().pulsePetalDensity).build());
    public static final ConfiguredFeature<?,?> MUSCARI_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.MUSCARI.getDefaultState()), DoublePlantPlacer.INSTANCE)).tries(FloralConfig.get().muscariDensity).build());
    public static final ConfiguredFeature<?,?> FAIRY_BLOSSOM_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.FAIRY_BLOSSOM.getDefaultState()), DoublePlantPlacer.INSTANCE)).tries(FloralConfig.get().fairyBlossomDensity).build());
