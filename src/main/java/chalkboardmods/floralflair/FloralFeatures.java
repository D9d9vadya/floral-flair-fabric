...
public class FloralFeatures {
    ...
    public static final ConfiguredFeature<?,?> FOXNIP_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.FOXNIP.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().foxnipDensity).spreadX(3).spreadZ(3).spreadY(1).build());
    public static final ConfiguredFeature<?,?> FROSTED_FOXNIP_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.FROSTED_FOXNIP.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().frostedFoxnipDensity).spreadX(3).spreadZ(3).spreadY(1).build());
    public static final ConfiguredFeature<?,?> ROSE_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.ROSE.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().roseDensity).spreadX(3).spreadZ(3).spreadY(1).build());
    public static final ConfiguredFeature<?,?> SUNSET_POPPY_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.SUNSET_POPPY.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().sunsetPoppyDensity).spreadX(3).spreadZ(3).spreadY(1).build());
    public static final ConfiguredFeature<?,?> JUNGLE_GEM_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.JUNGLE_GEM.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().jungleGemDensity).spreadX(3).spreadZ(3).spreadY(1).build());
    public static final ConfiguredFeature<?,?> PULSE_PATCH = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder (new SimpleBlockStateProvider(FloralFlair.PULSE_PETAL.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(FloralConfig.get().pulsePetalDensity).spreadX(3).spreadZ(3).spreadY(1).build());
