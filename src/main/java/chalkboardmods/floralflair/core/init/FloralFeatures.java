...
public class FloralFeatures {
    ...
    public static void init() {
        ...
        SPIKED_TULIP_PF = Registry.register(BuiltinRegistries.PLACED_FEATURE, spiked_tulipPlacement.getValue(), SPIKED_TULIP_CF.withPlacement(RarityFilterPlacementModifier.of(16), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP,PlacedFeatures.BOTTOM_TO_120_RANGE,PlacedFeatures.BOTTOM_TO_TOP_RANGE, BiomePlacementModifier.of()));
        ...
        STONNETE_PF = Registry.register(BuiltinRegistries.PLACED_FEATURE, stonnetePlacement.getValue(), STONNETE_CF.withPlacement(RarityFilterPlacementModifier.of(16), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP,PlacedFeatures.BOTTOM_TO_120_RANGE,PlacedFeatures.BOTTOM_TO_TOP_RANGE, BiomePlacementModifier.of()));
